...
export const sampleCards: CardData[] = [
  // GitHub #1
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/18068767/pexels-photo-18068767.png?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      stars: 24500,
      forks: 3200,
      language: 'PyTorch',
  ...
  // GitHub #2
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/5829726/pexels-photo-5829726.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      stars: 8900,
      forks: 1200,
      language: 'Python',
  ...
  // GitHub #3
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/30869081/pexels-photo-30869081.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      stars: 5600,
      forks: 920,
      language: 'TypeScript',
  ...
  // HuggingFace #1
  {
    ...
    publishedDate: 'Mar 9',
    imageUrl: 'https://images.pexels.com/photos/3782235/pexels-photo-3782235.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      likes: 2340,
      downloads: 156000,
  ...
  // HuggingFace #2
  {
    ...
    publishedDate: 'Mar 8',
    imageUrl: 'https://images.pexels.com/photos/16380905/pexels-photo-16380905.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      likes: 1890,
      downloads: 98500,
  ...
  // OpenAI Blog #1
  {
    ...
    publishedDate: 'Mar 7',
    imageUrl: 'https://images.pexels.com/photos/7203695/pexels-photo-7203695.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      category: 'Research',
      readTimeMin: 8,
    },
  ...
  // OpenAI Blog #2
  {
    ...
    publishedDate: 'Mar 6',
    imageUrl: 'https://images.pexels.com/photos/18498317/pexels-photo-18498317.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
      category: 'Safety',
      readTimeMin: 10,
    },
  ...
  // Anthropic Blog #1
  {
    ...
    publishedDate: 'Mar 5',
    imageUrl: 'https://images.pexels.com/photos/17483874/pexels-photo-17483874.png?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    metadata: {
