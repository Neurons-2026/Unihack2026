...
def main() -> None:
    ...
    print(f"Scraping top {args.limit} articles from Anthropic News...")
    ...
    out_path = out_dir / f"anthropic_news_{stamp}.json"
    latest_path = out_dir / "anthropic_news_latest.json"
